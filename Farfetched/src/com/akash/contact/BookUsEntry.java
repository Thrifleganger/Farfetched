...
public class BookUsEntry {
	...
	public String execute() throws IOException{
		...
		int affectedRows = jdbcHelper.insertBookingDetails(name,email,number,description,currentTime);
		
		if(!(affectedRows == 0)){			
			isEmailSent = emailHelper.bookUsInternalMail(name,email,number,description);
